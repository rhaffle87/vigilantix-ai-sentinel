  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-sidebar-border">
      <SidebarHeader className="border-b border-sidebar-border">
        <div className={cn("flex items-center gap-2 py-3", collapsed ? "justify-center px-0" : "px-2")}>
          <div className={cn(
            "relative flex shrink-0 items-center justify-center rounded-md bg-gradient-primary glow-primary transition-all duration-200",
            collapsed ? "h-8 w-8" : "h-9 w-9"
          )}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={cn("text-primary-foreground transition-all duration-200", collapsed ? "h-4 w-4" : "h-5 w-5")}>
